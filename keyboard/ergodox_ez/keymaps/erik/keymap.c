 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | ESC    |   1  |   2  |   3  |   4  |   5  | INS  |           | ESC  |   6  |   7  |   8  |   9  |   0  |   ]    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  |  \   |           | = +  |   Y  |   U  |   I  |   O  |   P  |   [    |
 * |--------+------+------+------+------+------|      |           | SE ´ |------+------+------+------+------+--------|
 * | Caps   |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  |   '    |
 * |--------+------+------+------+------+------|  <   |           | - _  |------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  | (SE) |           |      |   N  |   M  |   ,  |   .  |   /  | RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  L1  |  L2  | SUPR | ALT  | CTRL |                                       | CTRL | ALT  | SUPR |  L2  |  L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_FN1,  KC_FN2, KC_LGUI, KC_LALT, KC_LCTL,
                                                 KC_MPLY, KC_MNXT,
                                                          KC_HOME,
        ...
        KC_MINS, KC_N, KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                       KC_RCTL, KC_RALT, KC_RGUI, KC_FN2,  KC_FN1,
        KC_VOLD, KC_VOLU,
        KC_PGUP,
 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | Pause  | LEFT | DOWN | RGHT |  (   |   )  |------|           |------| Down |   4  |   5  |   6  |   +  |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      |      |  [   |   ]  |      |           |      |      |   1  |   2  |   3  |   \  |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |      |    . |   0  |   =  |      |
...
[SYMB] = KEYMAP(
       ...
       KC_SLCK, KC_TRNS, KC_UP,   KC_TRNS, KC_LCBR, KC_RCBR, KC_TRNS,
       KC_PAUS, KC_LEFT, KC_DOWN, KC_RGHT, KC_LPRN, KC_RPRN,
